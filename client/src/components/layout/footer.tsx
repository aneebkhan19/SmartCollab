        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-primary transition-colors">Our Team</a></li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-400">100 Innovation Drive<br />Suite 200<br />Tech City, TX 75001</span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <a href="tel:+1-555-AI-VORAL" className="text-gray-400 hover:text-primary transition-colors">+1-555-AI-VORAL</a>
              </li>
            </ul>
          </div>
        </div>
